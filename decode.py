#!/usr/bin/env python
#python3 decode.py trace_cathode2750V.dat
...
# Empty lists for time/voltage values
channels_t = [ ]
channels_v = [ ]
channels_vlist =[ ]
channels_tlist =[ ]
...
while True:    
    ...
    # the voltage info is 1024 floats with 2-byte precision
        ...
        """
        cellCalculate precise timing using the time bins and trigger
        ...
        to the i_th cell and select only even members, because
        the amplitude of the adjacent cells are averaged.
        The width of the bins 1024-2047 is identical to the bins
        0-1023, that is why the arrays are simply extended
        ...
        t = t - (t_0 - t_00) # correction with # TODO: it is a bit unclear how to do the correction
